...
describe('Crate', function () {
    before(function (done) {
        ...
        mongoose.connect('mongodb://localhost:27017/cratetest', done)
    })
    ...
    it('should attach file embed', (done) => {
        ...
        storage.save.callsArgWith(2,undefined, undefined, randomString(10))
    ...
    it('should remove attachment when attachment is deleted from model with file processor and multiple transforms', (done) => {
        ...
        fileProcessor.process = _.bind( function(model,attachment, modelProperty, callback){
            this.storage.save(attachment, (error, path) => {
